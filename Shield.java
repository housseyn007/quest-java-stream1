...
public class Shield {
    ...
    public static void main(String[] args) {
       ...
       elders =  heroes.stream().filter( hero -> hero.getAge() >= 60).collect(Collectors.toList());
        System.out.println("\nElders:");
        ...
        intolerants = heroes.stream().filter(hero -> hero.isGlutenIntolerant()).collect(Collectors.toList());
        System.out.println("\nGluten intolerants:");
